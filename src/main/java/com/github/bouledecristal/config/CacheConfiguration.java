package com.github.bouledecristal.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.github.bouledecristal.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.github.bouledecristal.repository.UserRepository.USERS_BY_EMAIL_CACHE);
